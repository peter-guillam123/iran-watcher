...
<section class="featured">
  <h3>Comparisons vs. ISW Iran Update</h3>
  <a class="feat" href="compare-isw-2026-04-21.html">
    <div class="feat-title">21 April 2026 · busy day, sanctions match</div>
    <div class="feat-blurb">19 of our items vs. ISW's ~8,000-word brief. The Mahan Air sanctions designation lands on the same day on both sides; Iran International is unusually rich on regime-domestic-life that ISW doesn't touch.</div>
  </a>
  <a class="feat" href="compare-isw-2026-04-24.html">
    <div class="feat-title">24 April 2026 · UK angle is loudest here</div>
    <div class="feat-blurb">22 items including five UK Parliament Q&amp;As on Arms Trade and Starmer's IRGC-ban pledge — the day where the UK-newsroom case is at its sharpest. State Department and OFAC sanctions on Iran's China oil network land on the same day.</div>
  </a>
  <a class="feat" href="compare-isw-2026-04-30.html">
    <div class="feat-title">30 April 2026 · the original comparison</div>
    <div class="feat-blurb">A 48h window matching ISW's 30 April report. 18 items; broader geopolitical core caught (Strait of Hormuz coalition, Iranian internal politics, economy collapse), tactical military layer missed.</div>
  </a>
